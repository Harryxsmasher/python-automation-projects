...
# Selection + Visibility Toggle + Continuous Movement
# =========================================================
...
def resolveMainGroup():
    ...
    if not nodes:
        ...
        return False
    mainGroup = nodes[0]
    print("✅ Main group resolved:", mainGroup.getName())
    return True
...
class MoveWidget(QtWidgets.QWidget):
    ...
    def onSelectionChanged(self, current, previous):
        ...
        print("✅ Selected:", targetNode.getName())
    ...
    def onVisibilityChanged(self, item):
        ...
        # ✅ Correct API for your VRED
        node.setActive(visible)

        print(("✅ Visible" if visible else "❌ Hidden"), node.getName())
...
if resolveMainGroup():
    ui = MoveWidget()
    ui.show()
    print("✅ Controller with visibility toggles loaded successfully")